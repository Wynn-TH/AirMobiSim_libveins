...
list(APPEND grpc_COMPONENT_NAMES gRPC::address_sorting gRPC::upb gRPC::grpc_plugin_support grpc::grpc_execs gRPC::gpr gRPC::grpc gRPC::grpc_unsecure gRPC::grpc++ gRPC::grpc++_unsecure gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpcpp_channelz)
list(REMOVE_DUPLICATES grpc_COMPONENT_NAMES)
if(DEFINED grpc_FIND_DEPENDENCY_NAMES)
  list(APPEND grpc_FIND_DEPENDENCY_NAMES absl OpenSSL protobuf ZLIB)
  list(REMOVE_DUPLICATES grpc_FIND_DEPENDENCY_NAMES)
else()
  set(grpc_FIND_DEPENDENCY_NAMES absl OpenSSL protobuf ZLIB)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(grpc_PACKAGE_FOLDER_RELEASE "/home/tianhao/.conan2/p/b/grpc1553df62cdfbf/p")
...
set(grpc_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_LIBRARY_TYPE_RELEASE SHARED)
set(grpc_IS_HOST_WINDOWS_RELEASE 0)
set(grpc_LIBS_RELEASE grpcpp_channelz grpc++_reflection grpc++_error_details grpc++_alts grpc++_unsecure grpc++ grpc_unsecure grpc gpr grpc_plugin_support upb address_sorting)
...
set(grpc_COMPONENTS_RELEASE gRPC::address_sorting gRPC::upb gRPC::grpc_plugin_support grpc::grpc_execs gRPC::gpr gRPC::grpc gRPC::grpc_unsecure gRPC::grpc++ gRPC::grpc++_unsecure gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpcpp_channelz)
...
set(grpc_gRPC_grpcpp_channelz_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpcpp_channelz_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc++_reflection_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc++_reflection_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc++_error_details_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc++_error_details_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc++_alts_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc++_alts_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc++_unsecure_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc++_unsecure_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc++_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc++_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc_unsecure_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc_unsecure_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc_unsecure_DEPENDENCIES_RELEASE gRPC::address_sorting gRPC::gpr gRPC::upb absl::flat_hash_map absl::inlined_vector absl::statusor ZLIB::ZLIB absl::random_random)
...
set(grpc_gRPC_grpc_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc_DEPENDENCIES_RELEASE gRPC::address_sorting gRPC::gpr gRPC::upb absl::bind_front absl::flat_hash_map absl::inlined_vector absl::statusor absl::random_random OpenSSL::Crypto OpenSSL::SSL ZLIB::ZLIB)
...
set(grpc_gRPC_gpr_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_gpr_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_grpc_grpc_execs_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_grpc_grpc_execs_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_grpc_plugin_support_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_grpc_plugin_support_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_upb_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_upb_LIBRARY_TYPE_RELEASE SHARED)
...
set(grpc_gRPC_address_sorting_BIN_DIRS_RELEASE "${grpc_PACKAGE_FOLDER_RELEASE}/bin")
set(grpc_gRPC_address_sorting_LIBRARY_TYPE_RELEASE SHARED)
